...
void main() 
{
    ...
    OPTION_REGbits.TMR0CS = 1;  // RA4 TOCKI
    OPTION_REGbits.TMR0SE = 0;  // bajo a alto (low to high)
    OPTION_REGbits.PSA = 1;     // 1:1
